...
include("./header.php")?>
    <main>
        ...
        $nbRec = $db->getNbRecetteIngredient($ing);
        $nbRec = intval($nbRec / 10);
        if ($nbRec + 1 >= $nbaff) {
            $stmt = $db->getRecetteIngredient($ing, ($nbaff - 1) * 10);
        ...
        <div id="pagination">
            ...
            {
                ?>
                <form action="../Controller/IngredientController.php" method="GET">
                    <input type='hidden' name="page" value="<?= $i ?>">
                    <input type="hidden" name="ingredient" value="<?= $_GET["ingredient"] ?>">
